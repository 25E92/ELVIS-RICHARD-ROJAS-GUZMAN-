...
# Calcular el pago total con el descuento y redondearlo a dólares
pago_total_con_descuento = round(pago_total_sin_descuento - monto_descuento)
...
print(f"Pago total (con descuento y redondeado a dólares): ${pago_total_con_descuento}")
